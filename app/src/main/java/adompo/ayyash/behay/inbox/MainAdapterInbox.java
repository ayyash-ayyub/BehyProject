...
public class MainAdapterInbox extends RecyclerView.Adapter<MainAdapterInbox.MainHolderInbox> {
    ...
    public MainAdapterInbox(Context context, List<ItemObjectInbox.ObjectInbox.Results> resultsList) {
