...
public class RiwayatAsupanGizi extends Fragment {
    ...
    public static RiwayatAsupanGizi newInstance() {
        RiwayatAsupanGizi fragment = new RiwayatAsupanGizi();
        return fragment;
    }
    ...
    private void loadData() {
        ...
        String url = "http://administrator.behy.co/User/getRiwayatAsupanGizi/" + email;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Gson mGson = new GsonBuilder().create();
                RiwayatAsupanGiziList list = mGson.fromJson(response, RiwayatAsupanGiziList.class);

                setChartData(list.riwayatAsupanGiziModel);

                tl.removeAllViews();
                addHeaders();
                addData(list.riwayatAsupanGiziModel);
    ...
    private void setChartData(List<RiwayatAsupanGiziModel> list) {
        // raw values
        ArrayList<BarEntry> values = new ArrayList<>();

        for (RiwayatAsupanGiziModel model : list) {
    ...
    private void addData(List<RiwayatAsupanGiziModel> list) {
        TextView tvTanggal, tvEnergi, tvKarbohidrat, tvProtein, tvLemak;
        ...
        for (RiwayatAsupanGiziModel model : list) {
            ...
            tvEnergi = new TextView(getContext());
            tvEnergi.setText(String.format(Locale.getDefault(), "%.0f", model.kalori));
            tvEnergi.setTextColor(Color.BLACK);
