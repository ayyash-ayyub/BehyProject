...
import adompo.ayyash.behay.test.RiwayatAsupanGiziModel;
import adompo.ayyash.behay.test.RiwayatPemenuhanGiziList;
import adompo.ayyash.behay.test.RiwayatPemenuhanGiziModel;


public class RiwayatPemenuhanGizi extends Fragment {
    ...
    public static RiwayatPemenuhanGizi newInstance() {
        RiwayatPemenuhanGizi fragment = new RiwayatPemenuhanGizi();
        return fragment;
    }
    ...
    private void loadData() {
        ...
        String url = "http://administrator.behy.co/User/getRiwayatPemenuhanGizi/" + email;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Gson mGson = new GsonBuilder().create();
                RiwayatPemenuhanGiziList list = mGson.fromJson(response, RiwayatPemenuhanGiziList.class);

                setChartData(list.riwayatPemenuhanGizi);

                tl.removeAllViews();
                addHeaders();
                addData(list.riwayatPemenuhanGizi);
    ...
    private void setChartData(List<RiwayatPemenuhanGiziModel> list) {
        // raw values
        ArrayList<BarEntry> values = new ArrayList<>();

        for (RiwayatPemenuhanGiziModel model : list) {
    ...
    private void addData(List<RiwayatPemenuhanGiziModel> list) {
        TextView tvTanggal, tvEnergi, tvKarbohidrat, tvProtein, tvLemak;
