...
public class TinggiBadan extends AppCompatActivity {
    ...
    Button btnSimpanTinggit;
    EditText editTextTinggi;
    PrefManager pref;
    ProgressDialog progressDialog;

    public static final String KEY_EMAIL= "email";
    public static final String KEY_TINGGI_TUBUH= "tinggi_badan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpanTinggit = (Button)findViewById(R.id.btn_simpanTinggi);
        editTextTinggi = (EditText)findViewById(R.id.etxt_tinggi);

        btnSimpanTinggit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(editTextTinggi.getText().toString().isEmpty()){
    ...
    private void save() {
        ...
        StringRequest sR = new StringRequest(Request.Method.POST, ConfigUmum.SAVE_TINGGI,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_TINGGI_TUBUH, tinggi_badan);
